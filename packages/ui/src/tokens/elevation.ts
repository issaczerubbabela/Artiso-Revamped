...
// bottom zoom pill) uses the SAME recipe — deliberately a light blur, not
// a heavy frosted-glass one, so it reads as opaque matte rather than
// translucent glass.
...
// The active-tool icon glows amber (accentSecondary) — the one place that
